...
const Schema: z.ZodType<Prisma.HandlerUncheckedUpdateManyWithoutProfileNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => HandlerUpdateManyWithWhereWithoutProfileInputObjectSchema,
          ),
          z
            .lazy(
              () => HandlerUpdateManyWithWhereWithoutProfileInputObjectSchema,
...
export const HandlerUncheckedUpdateManyWithoutProfileNestedInputObjectSchema =
  Schema;
