...
const Schema: z.ZodType<Prisma.ConversationTagUncheckedCreateNestedManyWithoutMessageInput> =
  z
    .object({
      create: z
        .union([
...
export const ConversationTagUncheckedCreateNestedManyWithoutMessageInputObjectSchema =
  Schema;
