...
const Schema: z.ZodType<Prisma.ProfileUncheckedUpdateWithoutConversationTagInput> =
  z
    .object({
      id: z
        .union([
...
export const ProfileUncheckedUpdateWithoutConversationTagInputObjectSchema =
  Schema;
