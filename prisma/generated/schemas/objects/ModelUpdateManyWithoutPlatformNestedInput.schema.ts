...
const Schema: z.ZodType<Prisma.ModelUpdateManyWithoutPlatformNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ModelUpdateManyWithWhereWithoutPlatformInputObjectSchema),
        z
          .lazy(() => ModelUpdateManyWithWhereWithoutPlatformInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ModelUpdateManyWithoutPlatformNestedInputObjectSchema = Schema;
