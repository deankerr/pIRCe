...
const Schema: z.ZodType<Prisma.ProfileUncheckedUpdateManyWithoutModelNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ProfileUpsertWithWhereUniqueWithoutModelInputObjectSchema,
          ),
          z
            .lazy(
              () => ProfileUpsertWithWhereUniqueWithoutModelInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => ProfileUpdateWithWhereUniqueWithoutModelInputObjectSchema,
          ),
          z
            .lazy(
              () => ProfileUpdateWithWhereUniqueWithoutModelInputObjectSchema,
...
export const ProfileUncheckedUpdateManyWithoutModelNestedInputObjectSchema =
  Schema;
