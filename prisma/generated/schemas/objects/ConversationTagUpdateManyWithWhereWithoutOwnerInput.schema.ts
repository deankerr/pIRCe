...
const Schema: z.ZodType<Prisma.ConversationTagUpdateManyWithWhereWithoutOwnerInput> =
  z
    .object({
...
export const ConversationTagUpdateManyWithWhereWithoutOwnerInputObjectSchema =
  Schema;
