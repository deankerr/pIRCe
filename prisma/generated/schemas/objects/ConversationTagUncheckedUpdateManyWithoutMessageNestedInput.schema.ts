...
const Schema: z.ZodType<Prisma.ConversationTagUncheckedUpdateManyWithoutMessageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ConversationTagUncheckedUpdateManyWithoutMessageNestedInputObjectSchema =
  Schema;
