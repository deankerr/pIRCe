...
const Schema: z.ZodType<Prisma.ConversationTagUncheckedCreateNestedManyWithoutOwnerInput> =
  z
    .object({
      create: z
        .union([
...
export const ConversationTagUncheckedCreateNestedManyWithoutOwnerInputObjectSchema =
  Schema;
