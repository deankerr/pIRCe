...
const Schema: z.ZodType<Prisma.ModelUncheckedCreateNestedManyWithoutPlatformInput> =
  z
    .object({
      create: z
        .union([
...
export const ModelUncheckedCreateNestedManyWithoutPlatformInputObjectSchema =
  Schema;
