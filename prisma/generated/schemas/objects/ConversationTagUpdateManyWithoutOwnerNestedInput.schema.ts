...
const Schema: z.ZodType<Prisma.ConversationTagUpdateManyWithoutOwnerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ConversationTagUpdateManyWithoutOwnerNestedInputObjectSchema =
  Schema;
