...
const Schema: z.ZodType<Prisma.ProfileUpdateManyWithWhereWithoutModelInput> = z
  .object({
...
export const ProfileUpdateManyWithWhereWithoutModelInputObjectSchema = Schema;
